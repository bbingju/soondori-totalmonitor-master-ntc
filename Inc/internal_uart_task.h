...
void request_to_internal__THRESHOLD_SET(struct slot_s *, uint8_t channal, float threshold);
...
void request_to_internal__REVISION_APPLY_SET(struct slot_s *, uint8_t const mode);
