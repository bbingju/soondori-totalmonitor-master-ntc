...
{
    send_internal_req(slotNumber, CMD_CALIBRATION_NTC_CON_TABLE_CAL,
                      &TestData.mainBoard[MBS_RTD].UI8[0], 4);
...
{
    send_internal_req(slotNumber, CMD_CALIBRATION_NTC_CONSTANT_SET,
                      &TestData.ntcCalibrationConst.UI8[0], 4);
...
void DoThresholdSet(struct slot_properties_s *slot, uint8_t channal,
                    uni4Byte thresholdTemp)
{
...
void DoRevisionConstantSet(uint8_t slotNumber)
{
    ...
    send_internal_req(slotNumber, CMD_REVISION_CONSTANT_SET,
                      TestData.revisionConstant[slotNumber].UI8, 4);
